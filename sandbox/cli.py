...
Usage ``here [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``here --version``
- Run the sample command as ``here welcome [OPTIONS] NAME``
"""

from here import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to here", fg="cyan")
